...
prereqs:
	sudo apt-get install libtext-csv-perl libpdl-stats-perl plplot11-driver-xwin plplot11-driver-cairo libplplot-dev plplot11-driver-gd plplot11-driver-wxwidgets imview libaliased-perl libglu1-mesa-dev freeglut3-dev liburi-encode-perl
