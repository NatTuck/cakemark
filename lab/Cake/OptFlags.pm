...
unroll: -reassociate -loop-simplify -indvars -licm -loop-unswitch -loop-unroll -gvn -sccp -loop-deletion -instcombine -reassociate -adce -simplifycfg -loop-simplify -unroll-allow-partial
