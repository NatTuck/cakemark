...
sub add {
    ...
    croak "Undefined name" unless defined $name;
    croak "Undefined med" unless defined $med;
    croak "Undefined min" unless defined $min;
    croak "Undefined max" unless defined $max;
